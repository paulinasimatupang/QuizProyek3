...
  @endif
            ...
            <div class="card-body">
              <form action="/insertdatabarang" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="kodebarang" class="form-control" id="exampleInputkodebarang" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                  <label for="exampleInputnamabarang" class="form-label">Nama Barang</label>
                  <input type="text" name="namabarang" class="form-control" id="exampleInputnamabarang" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                  <label for="exampleInputsatuan" class="form-label">Satuan</label>
                  <input type="text" name="satuan" class="form-control" id="exampleInputsatuan" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputhargasatuan" class="form-label">Harga Satuan</label>
                    <input type="text" name="hargasatuan" class="form-control" id="exampleInputhargasatuan" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputstok" class="form-label">Stok</label>
                    <input type="text" name="stok" class="form-control" id="exampleInputstok" aria-describedby="emailHelp">
                </div>
    ...
    <h1 class="text-center mb-4">Riwayat Barang</h1>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $barang->stok }}</td>
              <td>
                <a href="/EditDataBarang/{{ $barang->id }}" type="button" class="btn btn-warning">Edit</a>
                <a href="/deletebarang/{{ $barang->id }}" type="button" class="btn btn-danger delete" data-id="{{ $barang->id }}">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
